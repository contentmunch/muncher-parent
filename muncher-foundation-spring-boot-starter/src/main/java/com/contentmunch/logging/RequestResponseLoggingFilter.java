...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    private void logRequest(ContentCachingRequestWrapper request) {
        ...
        log.info("Incoming Request: method={} uri={} headers={} body={}",
                request.getMethod(), request.getRequestURI(), maskHeaders(headers), maskBody(body));
    }
    ...
    private void logResponse(ContentCachingResponseWrapper response) {
        ...
        log.info("Outgoing Response: status={} headers={} body={}",
                response.getStatus(), maskHeaders(headers), maskBody(body));
    }
