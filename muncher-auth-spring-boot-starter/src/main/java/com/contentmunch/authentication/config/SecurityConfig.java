...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,TokenizationService tokenizationService,
            MuncherUserDetailsService userDetailsService,AuthConfigProperties authConfigProperties) throws Exception{
    ...
    public OncePerRequestFilter jwtAuthFilter(TokenizationService tokenizationService,
            MuncherUserDetailsService userDetailsService,AuthConfigProperties authConfig){
